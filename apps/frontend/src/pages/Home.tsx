...
// Локации ресторанов
const LOCATIONS = [
  { city: 'Vancouver', address: '1234 Robson Street, Vancouver, BC', lat: 49.2827, lng: -123.1207 },
  { city: 'Toronto', address: '567 Queen Street West, Toronto, ON', lat: 43.6532, lng: -79.3832 },
  { city: 'Montreal', address: '890 Saint-Catherine St W, Montreal, QC', lat: 45.5017, lng: -73.5673 },
  { city: 'Calgary', address: '345 17th Ave SW, Calgary, AB', lat: 51.0447, lng: -114.0719 },
  { city: 'Ottawa', address: '678 Rideau Street, Ottawa, ON', lat: 45.4215, lng: -75.6972 },
];
...
const Home: React.FC<HomeProps> = ({ onOpenModal }) => {
  ...
  const getMapUrl = () => {
    return `https://maps.google.com/maps?q=${selectedLocation.lat},${selectedLocation.lng}&z=14&output=embed`;
  };
  ...
  return (
    <div style={{ minHeight: '100vh', background: WHITE }}>
      ...
      <div style={{
          ...
          <div key={index} style={{
            ...
            <div style={{
              ...
              <Link to={s.link} style={{
                ...
                {s.btn} <span style={{ fontSize: '1.2rem' }}>→</span>
              </Link>
            </div>
          </div>
        ))}
        ...
        {/* Навигация слайдера */}
        <div style={{
          position: 'absolute', bottom: '30px', right: isMobile ? '20px' : '60px',
          zIndex: 10, display: 'flex', alignItems: 'center', gap: '16px',
        }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
            <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: '1.3rem', fontWeight: 700, color: '#FFFFFF' }}>
              {String(currentSlide + 1).padStart(2, '0')}
            </span>
            <span style={{ color: 'rgba(255,255,255,0.4)', fontSize: '1.3rem' }}>/</span>
            <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: '1.3rem', fontWeight: 700, color: 'rgba(255,255,255,0.4)' }}>
        ...
        <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: isMobile ? '32px' : '48px' }}>
            ...
            <h2 style={{
              ...
              fontWeight: 700, color: DARK, lineHeight: 1.2,
            }}>The SushiMate Difference</h2>
          </div>
            ...
            {perks.map((p, i) => (
              <div key={i} style={{
                ...
                <div style={{
                  ...
                  background: RED_BG, borderRadius: '50%',
                ...
                <div>
                  <h3 style={{
                    fontFamily: "'DM Sans', sans-serif", fontWeight: 700,
                    fontSize: '0.95rem', color: DARK, marginBottom: '6px',
                  }}>{p.title}</h3>
                  <p style={{ fontSize: '0.82rem', color: MUTED, lineHeight: 1.6 }}>{p.sub}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
          <div style={{
            ...
            <div>
              ...
              }}>Popular This Week</div>
              <h2 style={{
                fontFamily: "'Cormorant Garamond', serif",
                fontSize: isMobile ? '2rem' : '2.8rem',
                fontWeight: 700, color: DARK, lineHeight: 1,
              }}>Best Sellers</h2>
            </div>
            <Link to="/order" style={{
              fontFamily: "'DM Sans', sans-serif", fontSize: '0.72rem',
              fontWeight: 700, letterSpacing: '2px', textTransform: 'uppercase',
              color: RED, borderBottom: '2px solid #DC2626',
              paddingBottom: '4px', textDecoration: 'none', whiteSpace: 'nowrap',
            }}>Full Menu →</Link>
          </div>
      ...
      {/* ════════════════════════════════════════════════
          КАРТА С ЛОКАЦИЯМИ
          ════════════════════════════════════════════════ */}
      <div style={{ padding: isMobile ? '48px 20px' : '80px 40px', background: WHITE }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: isMobile ? '32px' : '48px' }}>
            <div style={{
              fontFamily: "'DM Sans', sans-serif", fontSize: '0.65rem',
            ...
            {LOCATIONS.map(loc => (
              <button
                ...
                style={{
                  padding: '10px 22px',
                  borderRadius: '50px',
                  border: selectedLocation.city === loc.city ? 'none' : `2px solid ${RED_DIM}`,
                  background: selectedLocation.city === loc.city ? RED : WHITE,
                  color: selectedLocation.city === loc.city ? '#fff' : MUTED,
                  fontFamily: "'DM Sans', sans-serif",
                  fontWeight: 700, fontSize: '0.75rem',
                  letterSpacing: '1.5px', textTransform: 'uppercase',
                  cursor: 'pointer', transition: 'all 0.2s',
                  boxShadow: selectedLocation.city === loc.city
                    ? '0 4px 16px rgba(220,38,38,0.3)'
                    : 'none',
                }}
                onMouseEnter={e => {
                  if (selectedLocation.city !== loc.city) {
          ...
          <div style={{
            ...
            <p style={{
              fontFamily: "'DM Sans', sans-serif",
              fontSize: '0.85rem', color: RED, fontWeight: 600,
            }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          marginBottom: '12px',
        }}>First Order Special</div>
        <h2 style={{
          fontFamily: "'Cormorant Garamond', serif",
          fontSize: isMobile ? '2rem' : '3rem',
          fontWeight: 700, color: '#FFFFFF', marginBottom: '12px',
        }}>10% Off — Code: SUSHIMATE10</h2>
        <p style={{
          color: 'rgba(255,255,255,0.8)',
          fontSize: isMobile ? '0.85rem' : '1rem',
          marginBottom: '28px', fontFamily: "'DM Sans', sans-serif",
        }}>Applies automatically at checkout for new customers in Canada</p>
        <Link to="/order" style={{
          display: 'inline-flex', alignItems: 'center', gap: '10px',
      ...
      {/* STATS */}
      <div style={{
        background: WHITE, borderTop: '1px solid #FEE2E2',
        ...
        <div style={{
          ...
          display: 'grid',
          gridTemplateColumns: isMobile ? 'repeat(2, 1fr)' : 'repeat(4, 1fr)',
          gap: isMobile ? '24px' : '40px', textAlign: 'center',
        }}>
          {stats.map((stat, i) => (
            <div key={i}>
              <div style={{
                ...
                fontWeight: 700, color: RED, lineHeight: 1,
                marginBottom: '8px',
              }}>{stat.n}</div>
              <div style={{
